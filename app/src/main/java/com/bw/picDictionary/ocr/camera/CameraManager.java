...
import com.bw.picDictionary.ocr.PlanarYUVLuminanceSource;
import com.bw.picDictionary.ocr.PreferencesActivity;
...
public final class CameraManager {
    ...
    private final CameraManagerConfig configManager;
    /**
     ...
     */
    private final CallBackCameraFoucs callBackCameraFoucs;
    ...
    public CameraManager(Context context) {
        ...
        this.configManager = new CameraManagerConfig(context);
        previewCallback = new PreviewCallback(configManager);
        callBackCameraFoucs = new CallBackCameraFoucs();
    }
    ...
    public void stopPreview() {
        if (camera != null && previewing) {
            ...
            callBackCameraFoucs.setHandler(null, 0);
            previewing = false;
        }
    }
    ...
    public void requestAutoFocus(Handler handler, int message) {
        if (camera != null && previewing) {
            callBackCameraFoucs.setHandler(handler, message);
            camera.autoFocus(callBackCameraFoucs);
        }
    }
