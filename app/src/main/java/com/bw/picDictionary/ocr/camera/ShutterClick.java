 ...
 */
public class ShutterClick extends ImageView {
    private OnShutterButtonListener mListener;
    private boolean mOldPressed;
    public ShutterClick(Context context) {
        super(context);
    }

    public ShutterClick(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public interface OnShutterButtonListener {
         ...
         */
        void onShutterButtonFocus(ShutterClick b, boolean pressed);

        void onShutterButtonClick(ShutterClick b);
    }
}